...
| Admission Supervisor Agent Call | 33 |
| Admission Supervisor Agent/内核地址空间切换 | 66 |
...
flowchart TB
    ...
    Supervisor["ring-3 Admission Supervisor"] -->|"Agent Call 27、29-39"| X86
...
- ring-3 Admission Supervisor、受认证 Agent Call 27 与 29 至 39、固定容量准入记录、
...
最新里程碑的完整契约见 [Fault 记录回收设计](docs/superpowers/specs/2026-07-19-fault-record-retirement-v1-design.md)
和 [实现计划](docs/superpowers/plans/2026-07-19-fault-record-retirement-v1.md)。
