...
| Admission Supervisor Agent Call | 34 |
| Admission Supervisor Agent/内核地址空间切换 | 68 |
...
flowchart TB
    ...
    Supervisor["ring-3 Admission Supervisor"] -->|"Agent Call 27、29-40"| X86
...
378 个事件，并把内核 debug-exit 状态也作为契约的一部分。成功运行包含以下证明行：
...
- ring-3 Admission Supervisor、受认证 Agent Call 27 与 29 至 40、固定容量准入记录、
...
最新里程碑的完整契约见 [Event 归档检查点设计](docs/superpowers/specs/2026-07-19-event-archive-checkpoint-v1-design.md)
和 [实现计划](docs/superpowers/plans/2026-07-19-event-archive-checkpoint-v1.md)。
