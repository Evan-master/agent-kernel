...
180 个事件，并把内核 debug-exit 状态也作为契约的一部分。成功运行的结尾是：
...
- 裸机 x86_64 隔离、时钟抢占、故障隔离/恢复、原生资源生命周期 Agent Call
  以及原生 Capability、Intent、Task、受管 Agent 生命周期 Agent Call。
...
最新里程碑的完整契约见 [Agent Manager 设计](docs/superpowers/specs/2026-07-17-x86-native-agent-manager-v0-design.md)
和 [实现计划](docs/superpowers/plans/2026-07-17-x86-native-agent-manager-v0.md)。
