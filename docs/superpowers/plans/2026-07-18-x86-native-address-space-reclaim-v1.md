# X86 Native Address-Space Reclaim V1 Plan

- [x] Define complete frame identity, pool token semantics, terminal ordering,
  evidence, and validation gates.
- [x] Add and observe red host contracts for table-frame aliasing and bounded
  reclamation-pool behavior.
- [x] Track the root and three private intermediate page-table frames during
