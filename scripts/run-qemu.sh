...
for expected in \
  ...
  "AGENT_KERNEL_PER_CPU_STACK_ISOLATION_OK" \
  ...
  "AGENT_KERNEL_AGENT_CALL_EVENT_SNAPSHOT_OK" \
  ...
  "AGENT_KERNEL_NATIVE_EVENT_SNAPSHOT_RETAINED_OK" \
  ...
  "event[413] resource_created" \
  "event[414] capability_granted" \
...
check_marker_count "AGENT_KERNEL_PER_CPU_GUARD_PAGES_OK" 1
check_marker_count "AGENT_KERNEL_IO_APIC_IRQ_ROUTING_OK" 1
...
check_marker_count "AGENT_KERNEL_TLB_FRAME_REUSE_OK" 1
check_marker_count "AGENT_KERNEL_PER_CPU_STACK_ISOLATION_OK" 1
...
check_marker_count "AGENT_KERNEL_AGENT_CALL_EVENT_SNAPSHOT_OK" 1
check_marker_count "AGENT_KERNEL_NATIVE_EVENT_SNAPSHOT_RETAINED_OK" 1
