...
- A filesystem, network stack, ring 3 multi-Agent scheduler, or complete physical hardware driver stack.
...
emitted by the immutable causal request at event 38 through the registered COM1
