...
pub enum EventKind {
    ...
    DmaMappingReleased,
    DmaMappingCancelled,
    InterruptRouteReserved,
    InterruptRouteActivated,
    InterruptRouteRevoking,
    InterruptRouteReleased,
    NetworkEndpointReserved,
    NetworkEndpointActivated,
    NetworkEndpointRevoking,
    NetworkEndpointReleased,
    NetworkTransmitPrepared,
    NetworkTransmitCompleted,
    NetworkTransmitFailed,
    NetworkReceiveRecorded,
    NetworkDatagramTransmitPrepared,
    NetworkDatagramTransmitCompleted,
    NetworkDatagramTransmitFailed,
    NetworkDatagramReceiveRecorded,
    ResourceCreated,
    ResourceRetired,
...
pub struct Event {
    ...
    pub waiter_kind: Option<crate::WaiterKind>,
