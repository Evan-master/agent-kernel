...
pub enum KernelError {
    ...
    EventArchiveReceiptMismatch,
    EventArchiveReceiptReplay,
    EventArchiveVerificationFailed,
    EventArchiveDurabilityRequired,
    EventArchiveRecoveryStateNotVirgin,
    EventArchiveRecoverySequenceExhausted,
    EventArchiveRecoveryVerificationFailed,
    ActionStoreFull,
    ...
    DmaDomainStoreFull,
    DmaAttachmentStoreFull,
    DmaMappingStoreFull,
    InterruptRouteStoreFull,
    NetworkEndpointStoreFull,
    NetworkTransferStoreFull,
    AgentAlreadyExists,
    AgentIdStale,
    AgentNotFound,
    AgentEntryNotFound,
    AgentImageNotFound,
    AgentImageSignerNotFound,
    AgentImageSignerAlreadyExists,
    AgentImageSignerPolicyInvalid,
    AgentImageSignerGenerationStale,
    AgentImageSignerGenerationExhausted,
    AgentImageSignerResourceMismatch,
    AgentImageSignerStatusMismatch,
    ...
    DmaDomainNotFound,
    DmaDeviceAlreadyAttached,
    DmaDeviceNotAttached,
    DmaRequesterAlreadyAttached,
    DmaAttachmentStatusMismatch,
    DmaMappingNotFound,
    DmaMappingInvalid,
    DmaMappingOverlap,
    DmaMappingStatusMismatch,
    DmaResourceBusy,
    InterruptRouteNotFound,
    InterruptRouteAlreadyExists,
    InterruptVectorInUse,
    InterruptRouteStatusMismatch,
    InterruptResourceBusy,
    NetworkEndpointNotFound,
    NetworkEndpointAlreadyExists,
    NetworkEndpointInvalid,
