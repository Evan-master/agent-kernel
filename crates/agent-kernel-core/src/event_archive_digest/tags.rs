...
pub(super) const fn event_kind(value: EventKind) -> u16 {
    match value {
        ...
        EventKind::DmaDomainCreated => 92,
        EventKind::DmaDeviceAttached => 93,
        EventKind::DmaDeviceDetaching => 99,
        EventKind::DmaDeviceDetached => 100,
        EventKind::DmaMappingReserved => 94,
        EventKind::DmaMappingActivated => 95,
        EventKind::DmaMappingRevoking => 96,
        EventKind::DmaMappingReleased => 97,
        EventKind::DmaMappingCancelled => 98,
        EventKind::InterruptRouteReserved => 101,
        EventKind::InterruptRouteActivated => 102,
        EventKind::InterruptRouteRevoking => 103,
        EventKind::InterruptRouteReleased => 104,
        EventKind::NetworkEndpointReserved => 105,
        EventKind::NetworkEndpointActivated => 106,
        EventKind::NetworkEndpointRevoking => 107,
        EventKind::NetworkEndpointReleased => 108,
        EventKind::NetworkTransmitPrepared => 109,
        EventKind::NetworkTransmitCompleted => 110,
        EventKind::NetworkTransmitFailed => 111,
        EventKind::NetworkReceiveRecorded => 112,
        EventKind::NetworkDatagramTransmitPrepared => 113,
        EventKind::NetworkDatagramTransmitCompleted => 114,
        EventKind::NetworkDatagramTransmitFailed => 115,
        EventKind::NetworkDatagramReceiveRecorded => 116,
