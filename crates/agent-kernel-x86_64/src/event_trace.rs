...
const fn label(kind: EventKind) -> &'static str {
    match kind {
        ...
        EventKind::DmaDomainCreated => "dma_domain_created",
        EventKind::DmaDeviceAttached => "dma_device_attached",
        EventKind::DmaDeviceDetaching => "dma_device_detaching",
        EventKind::DmaDeviceDetached => "dma_device_detached",
        EventKind::DmaMappingReserved => "dma_mapping_reserved",
        EventKind::DmaMappingActivated => "dma_mapping_activated",
        EventKind::DmaMappingRevoking => "dma_mapping_revoking",
        EventKind::DmaMappingReleased => "dma_mapping_released",
        EventKind::DmaMappingCancelled => "dma_mapping_cancelled",
        EventKind::InterruptRouteReserved => "interrupt_route_reserved",
        EventKind::InterruptRouteActivated => "interrupt_route_activated",
        EventKind::InterruptRouteRevoking => "interrupt_route_revoking",
        EventKind::InterruptRouteReleased => "interrupt_route_released",
        EventKind::NetworkEndpointReserved => "network_endpoint_reserved",
        EventKind::NetworkEndpointActivated => "network_endpoint_activated",
        EventKind::NetworkEndpointRevoking => "network_endpoint_revoking",
        EventKind::NetworkEndpointReleased => "network_endpoint_released",
        EventKind::NetworkTransmitPrepared => "network_transmit_prepared",
        EventKind::NetworkTransmitCompleted => "network_transmit_completed",
        EventKind::NetworkTransmitFailed => "network_transmit_failed",
        EventKind::NetworkReceiveRecorded => "network_receive_recorded",
        EventKind::NetworkDatagramTransmitPrepared => "network_datagram_transmit_prepared",
        EventKind::NetworkDatagramTransmitCompleted => "network_datagram_transmit_completed",
        EventKind::NetworkDatagramTransmitFailed => "network_datagram_transmit_failed",
        EventKind::NetworkDatagramReceiveRecorded => "network_datagram_receive_recorded",
