...
pub const AGENT_CALL_COMPARE_AND_REBIND_NAMESPACE_ENTRY: u64 = 48;
...
pub const AGENT_CALL_DRIVER_COMMAND_CONFIGURE: u64 = 2;
...
pub const AGENT_CALL_RESOURCE_IOMMU: u64 = 8;
pub const AGENT_CALL_RESOURCE_DMA_DOMAIN: u64 = 9;
pub const AGENT_CALL_RESOURCE_INTERRUPT_ROUTE: u64 = 10;
...
impl AgentCallRequest {
    pub fn decode(frame: &PrivilegeInterruptStackFrame) -> Result<Self, AgentCallDecodeError> {
        ...
        match operation {
            ...
            AgentCallOperation::CompareAndRebindNamespaceEntry => {
                namespace::decode_compare_rebind(frame)
            }
            AgentCallOperation::CompareAndRetireNamespaceEntry => {
                namespace::decode_compare_retire(frame)
            }
