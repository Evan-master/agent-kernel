//! Strict register decoding for Agent Image record retirement calls.

use agent_kernel_core::{AgentImageId, CapabilityId};
...
pub(super) fn decode(
    ...
    Ok(AgentCallRequest::RetireAgentImageRecord {
        agent,
        task,
        image,
        nonce,
        authority: CapabilityId::new(frame.r10),
        target: AgentImageId::new(frame.r11),
    })
}
