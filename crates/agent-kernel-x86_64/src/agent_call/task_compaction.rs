//! Strict register decoding for Task Store compaction calls.

use agent_kernel_core::{CapabilityId, TaskId};
...
pub(super) fn decode(
    ...
    Ok(AgentCallRequest::CompactTasks {
        agent,
        task,
        image,
        nonce,
        authority: CapabilityId::new(frame.r10),
        through: TaskId::new(frame.r11),
    })
}
