//! Strict register decoding for Intent Store compaction calls.

use agent_kernel_core::{CapabilityId, IntentId};
...
pub(super) fn decode(
    ...
    Ok(AgentCallRequest::CompactIntents {
        agent,
        task,
        image,
        nonce,
        authority: CapabilityId::new(frame.r10),
        through: IntentId::new(frame.r11),
    })
}
