//! Strict register decoding for Waiter Store compaction calls.

use agent_kernel_core::{CapabilityId, WaiterId};
...
pub(super) fn decode(
    ...
    Ok(AgentCallRequest::CompactWaiters {
        agent,
        task,
        image,
        nonce,
        authority: CapabilityId::new(frame.r10),
        through: WaiterId::new(frame.r11),
    })
}
