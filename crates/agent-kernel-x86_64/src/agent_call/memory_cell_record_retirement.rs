//! Strict register decoding for terminal MemoryCell record retirement.

use agent_kernel_core::{CapabilityId, MemoryCellId};
...
pub(super) fn decode(
    ...
    Ok(AgentCallRequest::RetireMemoryCellRecord {
        agent,
        task,
        image,
        nonce,
        authority: CapabilityId::new(frame.r10),
        target: MemoryCellId::new(frame.r11),
    })
}
