//! Strict register decoding for Fault Store compaction calls.

use agent_kernel_core::{CapabilityId, FaultId};
...
pub(super) fn decode(
    ...
    Ok(AgentCallRequest::CompactFaults {
        agent,
        task,
        image,
        nonce,
        authority: CapabilityId::new(frame.r10),
        through: FaultId::new(frame.r11),
    })
}
