...
const FAULT_WORKER_RETURN_OFFSETS: [u32; 2] = [81, 90];
...
const FAULT_WORKER_CAPSULE: [u8; 124] = [
    b'A', b'G', b'N', b'T', b'I', b'M', b'G', 0, // magic
    1, 0, 1, 0, 1, 0, 0, 0, // format, architecture, kind, flags
    1, 0, 1, 0, 0, 0, 0, 0, // ABI, entry version, entry offset
    92, 0, 0, 0, 0, 0, 0, 0, // code length, reserved
    ...
    0x00, 0x01, 0xeb, 0xfe, 0x48, 0xb8, 0x41, 0x47, 0x4e, 0x54, 0x43, 0x41, 0x4c, 0x4c, 0xbb, 0x01,
    0x00, 0x00, 0x00, 0xb9, 0x01, 0x00, 0x00, 0x00, 0x31, 0xd2, 0xbe, 0x04, 0xe0, 0x4c, 0xd4, 0xcd,
    0x90, 0xb9, 0x03, 0x00, 0x00, 0x00, 0x31, 0xd2, 0xcd, 0x90, 0xeb, 0xfe,
];
...
const FAULT_WORKER_DIGEST: AgentImageDigest = AgentImageDigest::new([
    0x0b, 0x8c, 0x9a, 0x9c, 0x6e, 0x41, 0x64, 0x45, 0x79, 0x43, 0x39, 0x3a, 0xe2, 0x55, 0x9f, 0xc9,
    0xbb, 0x86, 0x80, 0xb5, 0xc2, 0x3b, 0xc6, 0x54, 0x6f, 0xe8, 0x53, 0xc2, 0x4e, 0x6f, 0xfa, 0x13,
]);
