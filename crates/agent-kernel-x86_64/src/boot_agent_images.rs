...
const FAULT_WORKER_RETURN_OFFSETS: [u32; 2] = [70, 79];
...
pub(super) const FAULT_WORKER_INVALID_OPCODE_OFFSET: u32 = 36;
pub(super) const FAULT_WORKER_GENERAL_PROTECTION_OFFSET: u32 = 38;
...
const FAULT_WORKER_CAPSULE: [u8; 113] = [
    b'A', b'G', b'N', b'T', b'I', b'M', b'G', 0, // magic
    1, 0, 1, 0, 1, 0, 0, 0, // format, architecture, kind, flags
    1, 0, 1, 0, 0, 0, 0, 0, // ABI, entry version, entry offset
    81, 0, 0, 0, 0, 0, 0, 0, // code length, reserved
    0x48, 0xb8, 0x00, 0x10, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x80, 0x78, 0x01, 0x01, 0x72, 0xfa,
    0x80, 0x78, 0x02, 0x00, 0x74, 0x0e, 0x80, 0x78, 0x02, 0x01, 0x74, 0x0a, 0x80, 0x78, 0x02, 0x02,
    0x74, 0x07, 0xeb, 0xfe, 0x0f, 0x0b, 0xfa, 0xeb, 0xf9, 0x48, 0xb8, 0x41, 0x47, 0x4e, 0x54, 0x43,
    0x41, 0x4c, 0x4c, 0xbb, 0x01, 0x00, 0x00, 0x00, 0xb9, 0x01, 0x00, 0x00, 0x00, 0x31, 0xd2, 0xbe,
    0x04, 0xe0, 0x4c, 0xd4, 0xcd, 0x90, 0xb9, 0x03, 0x00, 0x00, 0x00, 0x31, 0xd2, 0xcd, 0x90, 0xeb,
    0xd1,
];
...
const FAULT_WORKER_DIGEST: AgentImageDigest = AgentImageDigest::new([
    0x09, 0x45, 0x12, 0xb8, 0x7c, 0x03, 0x35, 0xb1, 0x84, 0xaa, 0x38, 0x72, 0xa0, 0x1a, 0xf2, 0x68,
    0x7c, 0xa6, 0x1f, 0x1a, 0x06, 0xe2, 0xd7, 0x7b, 0xa7, 0x40, 0xe1, 0x1f, 0xd1, 0xfd, 0x87, 0xc3,
]);
