...
pub struct ArchiveKernelFixture {
...
pub fn launched_archive_kernel() -> ArchiveKernelFixture {
    ...
    kernel
        .sys_emit_signal(actor, archive_authority, root, SignalKey::new(91))
        .unwrap();

    ArchiveKernelFixture {
        kernel,
        actor,
        task,
        image,
